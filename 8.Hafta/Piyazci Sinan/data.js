...
// We created an array of EU countries to filter the European Union countries.
export const EUCountries = ["Austria", "Belgium", "Bulgaria", "Croatia", "Republic of Cyprus", "Czech Republic", "Denmark", "Estonia", "Finland", "France", "Germany", "Greece", "Hungary", "Ireland", "Italy", "Latvia", "Lithuania", "Luxembourg", "Malta", "Netherlands", "Poland", "Portugal", "Romania", "Slovakia", "Slovenia", "Spain", "Sweden"];

// We created an array to filter the Swiss Romande Region cantons.
export const swissRomandeRegion = ["VD","VS","GE","BE","FR","NE","JU"];